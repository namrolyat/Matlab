...
Parameters.Experiment = 'BarGratingPilot';
Parameters.CLabels = {'Short Bar', 'Long Bar', 'Grating'};
...
Parameters.ITI = 2;                 %Inter-Trial Interval (from end of Match task)

Parameters.CueDelay = 0.25;
Parameters.CueDuration = 0.125;
Parameters.CRInterval = 1.5;     
...
if Parameters.runnr == 1    
    ...
    Parameters.CondList = Shuffle(repmat((1:nconds)', Parameters.NumRuns/nconds, 1));
else
...
switch Parameters.CondList(Parameters.runnr)
    case 1
        Parameters.MatchStimType = 'Line';
        Parameters.LineLengthDeg = 1.4;
    case 2
        Parameters.MatchStimType = 'Line';
        Parameters.LineLengthDeg = Parameters.AnnOutRad;
    case 3
        Parameters.MatchStimType = 'Grating';
end

questdlg(['In this run, the match stimulus will be a ', Parameters.CLabels(Parameters.CondList(Parameters.runnr))], 'Condition');
