...
% Known Problems
%
% Sometimes Matlab produces and error when trying to open an serial object,
% like: 
%    Error using ==> serial.fopen at 72
%
% Most of the time this is due to a program still using the same serial
% port or because the port hasn't been closed properly. Worst case you'll
% have to reboot the system and try again. This will mostly solve the 
% problem.
