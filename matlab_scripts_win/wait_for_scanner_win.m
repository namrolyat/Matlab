...
function [ onset_first_trigger] = wait_for_scanner_win()
...
switch SCANNER
    case 'Skyra'
        scannertrigger = 97;
        bitsiboxScanner = Bitsi('com2');
        bitsiboxButtons = Bitsi('com3');
    case 'buttonbox'
        scannertrigger = 97; % a
        quit_loop = 100;     % d
        bitsiboxScanner = Bitsi('com11');
    case 'test' 
        scannertrigger = 100;
        quit_loop = 97;
        bitsiboxScanner = Bitsi('com10');
